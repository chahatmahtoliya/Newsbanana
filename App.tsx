...
import { Newspaper, Download, Image as ImageIcon, Type, Palette, Grid, X, Moon, Sun, Save, Plus, Maximize2, Minimize2, Film, Layers, Move, Monitor, RotateCcw, Upload } from 'lucide-react';
